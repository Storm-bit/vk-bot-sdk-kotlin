...
import com.github.stormbit.vksdk.objects.models.enums.ConversationFilter
...
class MessagesApi(client: Client) : MethodsContext(client) {
    ...
    fun getConversationsById(
        ...
        fields: List<ObjectField> = emptyList(),
        groupId: Int? = null
    ): VkApiRequest<ExtendedListResponse<Conversation>> = Methods.getConversationsById.call(ExtendedListResponse.serializer(Conversation.serializer())) {
