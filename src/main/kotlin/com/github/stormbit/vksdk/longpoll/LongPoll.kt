...
class LongPoll(private val client: Client) {
    ...
    private val updatesHandler: UpdatesHandler<JsonElement> = when (client) {
        is GroupClient -> UpdatesHandlerGroup(client) as UpdatesHandler<JsonElement>

        else -> UpdatesHandlerUser(client) as UpdatesHandler<JsonElement>
    }
