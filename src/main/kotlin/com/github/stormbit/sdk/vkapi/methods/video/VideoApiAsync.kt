...
@Suppress("unused")
class VideoApiAsync(private val client: Client) : MethodsContext() {
    fun add(
            videoId: Int,
            ownerId: Int,
            targetId: Int? = null,
    ...
    fun createComment(
        ...
        client, JsonObject.serializer(), callback, parametersOf {
            ...
            append(
                "items",
                attachments?.joinToString(",", transform = CommentAttachment::attachmentString)
            )
