...
@Suppress("unused")
class GroupsApi(private val client: Client) : MethodsContext() {
    fun addAddress(
            groupId: Int,
            title: String,
            address: String,
    ...
    ): JsonObject? = Methods.addAddress.callSync(
    ...
    ): JsonObject? = Methods.addCallbackServer.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("url", url)
            append("title", title)
    ...
    fun addLink(
            ...
            link: String,
            text: String? = null
    ): JsonObject? = Methods.addLink.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("link", link)
            append("text", text)
    ...
    fun approveRequest(
            groupId: Int,
            userId: Int
    ): JsonObject? = Methods.approveRequest.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
    ...
    ): JsonObject? = Methods.ban.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
    ...
    ): JsonObject? = Methods.create.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("title", title)
    ...
    fun deleteAddress(
            groupId: Int,
            addressId: Int
    ): JsonObject? = Methods.deleteAddress.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
    ...
    fun deleteCallbackServer(
            groupId: Int,
            serverId: Int
    ): JsonObject? = Methods.deleteCallbackServer.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
    ...
    fun deleteLink(
            groupId: Int,
            linkId: Int
    ): JsonObject? = Methods.deleteLink.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
    ...
    fun disableOnline(
            groupId: Int
    ): JsonObject? = Methods.disableOnline.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
        }
    )
    ...
    fun editAddress(
            ...
            timetable: Address.Timetable? = null,
            isMainAddress: Boolean? = null
    ): JsonObject? = Methods.editAddress.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("address_id", addressId)
            append("title", title)
    ...
    fun editCallbackServer(
            ...
            title: String,
            secretKey: String? = null
    ): JsonObject? = Methods.editCallbackServer.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("server_id", serverId)
            append("url", url)
    ...
    fun editLink(
            ...
            linkId: Int,
            text: String? = null
    ): JsonObject? = Methods.editLink.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("link_id", linkId)
            append("text", text)
    ...
    ): JsonObject? = Methods.editManager.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("user_id", userId)
    ...
    fun editPlace(
            ...
            latitude: Double? = null,
            longitude: Double? = null
    ): JsonObject? = Methods.editPlace.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("title", title)
            append("address", address)
    ...
    fun enableOnline(
            groupId: Int
    ): JsonObject? = Methods.enableOnline.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
        }
    )
    ...
    ): JsonObject? = Methods.getAddresses.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
    ...
    fun getBanned(
            ...
            ownerId: Int? = null
    ): JsonObject? = Methods.getBanned.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("offset", offset)
            append("count", count)
    ...
    ): List<Community>? = Methods.getById.callSync(
        client, ListSerializer(Community.serializer()), parametersOf {
    ...
    fun getName(
            groupId: Int
    ): String = getById(listOf(groupId))!![0].name

    fun getCallbackConfirmationCode(
            groupId: Int
    ): JsonObject? = Methods.getCallbackConfirmationCode.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
        }
    )
    ...
    fun getCallbackServers(
            groupId: Int,
            serverIds: List<Int>?
    ): JsonObject? = Methods.getCallbackServers.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
    ...
    fun getCallbackSettings(
            groupId: Int,
            serverId: Int
    ): JsonObject? = Methods.getCallbackSettings.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("server_id", serverId)
        }
    ...
    ): JsonObject? = Methods.getCatalog.callSync(
        client, JsonObject.serializer(), parametersOf {
    ...
    ): JsonObject? = Methods.getCatalogInfo.callSync(
        client, JsonObject.serializer(), parametersOf {
    ...
    fun getInvitedUsers(
            ...
            nameCase: NameCase
    ): JsonObject? = Methods.getInvitedUsers.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("offset", offset)
            append("count", count)
    ...
    fun getInvites(
            ...
            count: Int,
            extended: Boolean
    ): JsonObject? = Methods.getInvites.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("offset", offset)
            append("count", count)
            append("extended", extended.toInt())
    ...
    fun getLongPollSettings(
            groupId: Int
    ): JsonObject? = Methods.getLongPollSettings.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
        }
    )
    ...
    fun getMembersIds(
            ...
            count: Int,
            onlyFriends: Boolean
    ): JsonObject? = Methods.getMembers.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
    ...
    fun getOnlineStatus(
            groupId: Int
    ): JsonObject? = Methods.getOnlineStatus.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
        }
    )
    ...
    fun getSettings(
            groupId: Int
    ): JsonObject? = Methods.getSettings.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
        }
    )

    fun getTokenPermissions(): JsonObject? = Methods.getTokenPermissions.callSync(
        client, JsonObject.serializer(), null)

    fun invite(
            groupId: Int,
            userId: Int
    ): JsonObject? = Methods.invite.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("user_id", userId)
        }
    ...
    fun isMember(
            groupId: Int,
            userId: Int? = null
    ): JsonObject? = Methods.isMember.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("user_id", userId)
            append("extended", 1)
    ...
    ): JsonObject? = Methods.join.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
    ...
    fun leave(
            groupId: Int
    ): JsonObject? = Methods.leave.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
        }
    )
    ...
    fun removeUser(
            groupId: Int,
            userId: Int
    ): JsonObject? = Methods.removeUser.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("user_id", userId)
        }
    ...
    fun reorderLink(
            ...
            linkId: Int,
            after: Int
    ): JsonObject? = Methods.reorderLink.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("link_id", linkId)
            append("after", after)
    ...
    ): JsonObject? = Methods.setCallbackSettings.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("server_id", serverId)
    ...
    fun setLongPollSettings(
            ...
            vkPayTransaction: Boolean? = null,
            appPayload: Boolean? = null
    ): JsonObject? = Methods.setLongPollSettings.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("api_version", apiVersion)
    ...
    ): JsonObject? = Methods.setSettings.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("messages", messages?.toInt())
    ...
    fun unban(
            groupId: Int,
            ownerId: Int
    ): JsonObject? = Methods.unban.callSync(
        client, JsonObject.serializer(), parametersOf {
            append("group_id", groupId)
            append("owner_id", ownerId)
        }
