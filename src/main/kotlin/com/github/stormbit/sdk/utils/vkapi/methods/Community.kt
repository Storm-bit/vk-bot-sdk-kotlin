...
data class Community(
    ...
    enum class CloseType(override val value: Int) : Utils.Companion.IntEnum {
        OPEN(0),
        CLOSED(1),
        PRIVATE(2);
    ...
    enum class AdminLevel(override val value: Int) : Utils.Companion.IntEnum {
        NO_ROLE(0),
        MODERATOR(1),
        EDITOR(2),
        ADMINISTRATOR(3);
    ...
    enum class AgeLimits(override val value: Int) : Utils.Companion.IntEnum {
        NO_LIMITS(1),
        SIXTEEN_PLUS(2),
        EIGHTEEN_PLUS(3);
    ...
    data class CommunityBan(
        ...
        enum class Reason(override val value: Int) : Utils.Companion.IntEnum {
            OTHER(0),
            SPAM(1),
            HARASSMENT(2),
            PROFANITY(3),
    ...
    enum class MainSectionType(override val value: Int) : Utils.Companion.IntEnum {
        NO(0),
        PHOTOS(1),
        TOPICS(2),
        AUDIOS(3),
    ...
    enum class MemberStatus(override val value: Int) : Utils.Companion.IntEnum {
        NOT_MEMBER(0),
        MEMBER(1),
        NOT_SURE(2),
    ...
    enum class WallCloseType(override val value: Int) : Utils.Companion.IntEnum {
        DISABLED(0),
        OPEN(1),
        LIMITED(2),
        CLOSED(3);
