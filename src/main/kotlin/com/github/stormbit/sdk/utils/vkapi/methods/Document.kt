...
data class Document(
        ...
        @SerialName("access_key") override val accessKey: String? = null) : CommentAttachment, WallAttachment, MessageAttachment {

    override val typeAttachment: AttachmentType get() = AttachmentType.DOC

    @Serializable(with = Type.Companion::class)
    enum class Type(override val value: Int) : Utils.Companion.IntEnum {
        TEXT(1),
        ARCHIVE(2),
        GIF(3),
        IMAGE(4),
